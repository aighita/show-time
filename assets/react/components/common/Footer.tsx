...
export function Footer() {
    return (
        <footer className="bg-background border-t border-border">
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                {/* Logo + Description */}
            ...
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 text-center text-muted-foreground text-xs">
